...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  Future<void> initialize() async {
    ...
    void errorListener(Object obj) {
      ...
      logHolder.log('errorListener=${e.message!}', level: 7);
      _timer?.cancel();
...
class VideoProgressIndicatorState extends State<VideoProgressIndicator> {
  ...
  @override
  void dispose() {
    logHolder.log('VideoProgressIndicatorState dispose', level: 6);
    super.dispose();
  }

  @override
  void deactivate() {
    logHolder.log('VideoProgressIndicatorState deactivate', level: 6);
