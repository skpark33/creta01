...
class WavePainter extends CustomPainter {
  ...
  _paintStartupWave(Canvas canvas, Size size) {
    ...
    double? waveHeight =
        lerpDouble(size.height, line.controlHeight, Curves.elasticOut.transform(animationProgress));
  ...
  _paintStoppingWave(Canvas canvas, Size size) {
    ...
    double? waveHeight =
        lerpDouble(line.controlHeight, size.height, Curves.elasticOut.transform(animationProgress));
  ...
  _paintWaveLine(Canvas canvas, Size size, WaveCurveDefinitions waveCurve) {
    ...
    path.cubicTo(waveCurve.rightControlPoint1, waveCurve.controlHeight,
        waveCurve.rightControlPoint2, size.height, waveCurve.endOfBezier, size.height);
    path.lineTo(size.width, size.height);
