...
class MyColorIndicator extends StatefulWidget {
  ...
  @override
  MyColorIndicatorState createState() => MyColorIndicatorState();
}

class MyColorIndicatorState extends State<MyColorIndicator> {
  ...
  @override
  void didUpdateWidget(covariant MyColorIndicator oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final bool _isLight = ThemeData.estimateBrightnessForColor(widget.color) == Brightness.light;
    ...
    final Color _borderColor = widget.borderColor ?? Theme.of(context).dividerColor;
    ...
    return Material(
      ...
      shape: RoundedRectangleBorder(
          ...
          side: widget.hasBorder ? BorderSide(color: _borderColor) : BorderSide.none),
      child: SizedBox(
        width: widget.width,
        ...
        child: InkWell(
          ...
          // use a lot of these MyColorIndicators with InkWells.
